...
public class BasicSeeder implements Seeder {
   ...
   @Override
   public void seed(OrganismRepository repo) {
       createSimpleArithmeticOrganism(repo);
       createTrigonometricAnalysisOrganism(repo);
       createDataTransformationOrganism(repo);
       createReductiveProcessingOrganism(repo);
       createBasicCompositeOrganism(repo);
   }
    ...
    */
   private void createSimpleArithmeticOrganism(OrganismRepository repo) {
    ...
    */
   private void createTrigonometricAnalysisOrganism(OrganismRepository repo) {
    ...
    */
   private void createDataTransformationOrganism(OrganismRepository repo) {
    ...
    */
   private void createReductiveProcessingOrganism(OrganismRepository repo) {
    ...
    */
   private void createBasicCompositeOrganism(OrganismRepository repo) {
